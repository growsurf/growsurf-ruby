...
class Growsurf::Test::PrimitiveModelTest < Minitest::Test
  A = Growsurf::Internal::Type::ArrayOf[-> { Integer }]
  H = Growsurf::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Growsurf::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Growsurf::Internal::Type::Unknown,
      Growsurf::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Growsurf::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Growsurf::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Growsurf::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Growsurf::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Growsurf::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Growsurf::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Growsurf::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Growsurf::Internal::Type::Boolean, true] => true,
      [Growsurf::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Growsurf::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Growsurf::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Growsurf::Internal::Type::Converter.new_coerce_state
      Growsurf::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Growsurf::Internal::Type::Converter.dump(target, input, state: state)
...
class Growsurf::Test::EnumModelTest < Minitest::Test
  class E0
    include Growsurf::Internal::Type::Enum
...
class Growsurf::Test::CollectionModelTest < Minitest::Test
  A1 = Growsurf::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Growsurf::Internal::Type::HashOf[Integer]

  A2 = Growsurf::Internal::Type::ArrayOf[H1]
  H2 = Growsurf::Internal::Type::HashOf[-> { A1 }]

  A3 = Growsurf::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Growsurf::Internal::Type::HashOf[Integer, nil?: true]
...
class Growsurf::Test::BaseModelTest < Minitest::Test
  class M1 < Growsurf::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Growsurf::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Growsurf::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Growsurf::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Growsurf::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Growsurf::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Growsurf::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Growsurf::Errors::ConversionError => e
...
class Growsurf::Test::UnionTest < Minitest::Test
  class U0
    include Growsurf::Internal::Type::Union
  ...
  class M2 < Growsurf::Internal::Type::BaseModel
  ...
  class M4 < Growsurf::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Growsurf::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Growsurf::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Growsurf::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Growsurf::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Growsurf::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Growsurf::Internal::Type::Unknown, Growsurf::Internal::Type::Unknown] => true,
      [Growsurf::Internal::Type::Boolean, Growsurf::Internal::Type::Boolean] => true,
      [Growsurf::Internal::Type::Unknown, Growsurf::Internal::Type::Boolean] => false,
...
class Growsurf::Test::MetaInfoTest < Minitest::Test
  A1 = Growsurf::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Growsurf::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
