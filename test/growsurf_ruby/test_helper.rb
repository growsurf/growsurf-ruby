...
class GrowsurfRuby::Test::SingletonClient < GrowsurfRuby::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: GrowsurfRuby::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class GrowsurfRuby::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @growsurf = GrowsurfRuby::Test::SingletonClient.instance
  end
