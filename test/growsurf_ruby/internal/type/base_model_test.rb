...
class GrowsurfRuby::Test::PrimitiveModelTest < Minitest::Test
  A = GrowsurfRuby::Internal::Type::ArrayOf[-> { Integer }]
  H = GrowsurfRuby::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < GrowsurfRuby::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      GrowsurfRuby::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => GrowsurfRuby::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [GrowsurfRuby::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [GrowsurfRuby::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [GrowsurfRuby::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = GrowsurfRuby::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        GrowsurfRuby::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [GrowsurfRuby::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [GrowsurfRuby::Internal::Type::Boolean, true] => true,
      [GrowsurfRuby::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => GrowsurfRuby::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        GrowsurfRuby::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = GrowsurfRuby::Internal::Type::Converter.new_coerce_state
      GrowsurfRuby::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        GrowsurfRuby::Internal::Type::Converter.dump(target, input, state: state)
...
class GrowsurfRuby::Test::EnumModelTest < Minitest::Test
  class E0
    include GrowsurfRuby::Internal::Type::Enum
...
class GrowsurfRuby::Test::CollectionModelTest < Minitest::Test
  A1 = GrowsurfRuby::Internal::Type::ArrayOf[-> { Integer }]
  H1 = GrowsurfRuby::Internal::Type::HashOf[Integer]

  A2 = GrowsurfRuby::Internal::Type::ArrayOf[H1]
  H2 = GrowsurfRuby::Internal::Type::HashOf[-> { A1 }]

  A3 = GrowsurfRuby::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = GrowsurfRuby::Internal::Type::HashOf[Integer, nil?: true]
...
class GrowsurfRuby::Test::BaseModelTest < Minitest::Test
  class M1 < GrowsurfRuby::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < GrowsurfRuby::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < GrowsurfRuby::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, GrowsurfRuby::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = GrowsurfRuby::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = GrowsurfRuby::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(GrowsurfRuby::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue GrowsurfRuby::Errors::ConversionError => e
...
class GrowsurfRuby::Test::UnionTest < Minitest::Test
  class U0
    include GrowsurfRuby::Internal::Type::Union
  ...
  class M2 < GrowsurfRuby::Internal::Type::BaseModel
  ...
  class M4 < GrowsurfRuby::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, GrowsurfRuby::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < GrowsurfRuby::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, GrowsurfRuby::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class GrowsurfRuby::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include GrowsurfRuby::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [GrowsurfRuby::Internal::Type::Unknown, GrowsurfRuby::Internal::Type::Unknown] => true,
      [GrowsurfRuby::Internal::Type::Boolean, GrowsurfRuby::Internal::Type::Boolean] => true,
      [GrowsurfRuby::Internal::Type::Unknown, GrowsurfRuby::Internal::Type::Boolean] => false,
...
class GrowsurfRuby::Test::MetaInfoTest < Minitest::Test
  A1 = GrowsurfRuby::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = GrowsurfRuby::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
