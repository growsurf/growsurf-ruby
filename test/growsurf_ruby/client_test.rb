...
class GrowsurfRubyTest < Minitest::Test
  ...
  def test_client_given_request_default_retry_attempts
    ...
    growsurf = GrowsurfRuby::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_retry_after_seconds
    ...
    growsurf = GrowsurfRuby::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(GrowsurfRuby::Errors::APIConnectionError) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: GrowsurfRuby::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: GrowsurfRuby::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
