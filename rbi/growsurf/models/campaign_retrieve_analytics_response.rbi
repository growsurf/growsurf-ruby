  ...
  module Models
    class CampaignRetrieveAnalyticsResponse < Growsurf::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Growsurf::Models::CampaignRetrieveAnalyticsResponse,
            Growsurf::Internal::AnyHash
          )
        end

      sig do
        returns(Growsurf::Models::CampaignRetrieveAnalyticsResponse::Analytics)
      end
      ...
      sig do
        params(
          analytics:
            Growsurf::Models::CampaignRetrieveAnalyticsResponse::Analytics::OrHash
        ).void
      end
      ...
      sig do
        override.returns(
          {
            analytics:
              Growsurf::Models::CampaignRetrieveAnalyticsResponse::Analytics,
            end_date: Integer,
            start_date: Integer
          }
        )
