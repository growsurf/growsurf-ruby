    ...
    module Campaign
      class ParticipantListReferralsParams < Growsurf::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Growsurf::Campaign::ParticipantListReferralsParams,
        ...
        module SortBy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Growsurf::Campaign::ParticipantListReferralsParams::SortBy
              )
            end
          ...
          UPDATED_AT =
            T.let(
              :updatedAt,
              Growsurf::Campaign::ParticipantListReferralsParams::SortBy::TaggedSymbol
            )
          CREATED_AT =
            T.let(
              :createdAt,
