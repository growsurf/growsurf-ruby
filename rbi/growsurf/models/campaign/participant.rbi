    ...
    module Campaign
      class CampaignParticipant < Growsurf::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Growsurf::Campaign::CampaignParticipant,
        ...
        sig do
          returns(T.nilable(Growsurf::Campaign::FraudRiskLevel::TaggedSymbol))
        end
        attr_reader :fraud_risk_level

        sig do
          params(
            fraud_risk_level: Growsurf::Campaign::FraudRiskLevel::OrSymbol
          ).void
        end
        ...
        sig do
          returns(T.nilable(Growsurf::Campaign::ReferralSource::TaggedSymbol))
        end
        attr_reader :referral_source

        sig do
          params(
            referral_source: Growsurf::Campaign::ReferralSource::OrSymbol
          ).void
        end
        attr_writer :referral_source

        sig do
          returns(T.nilable(Growsurf::Campaign::ReferralStatus::TaggedSymbol))
        end
        ...
        sig do
          returns(T.nilable(Growsurf::Campaign::CampaignParticipant::Referrer))
        end
        ...
        sig do
          params(
            referrer:
              T.nilable(
                Growsurf::Campaign::CampaignParticipant::Referrer::OrHash
              )
          ).void
        end
          ...
          override.returns(
            {
              ...
              fraud_reason_code: String,
              fraud_risk_level:
                Growsurf::Campaign::FraudRiskLevel::TaggedSymbol,
              impression_count: Integer,
              invite_count: Integer,
              ip_address: T.nilable(String),
              is_new: T::Boolean,
              ...
              prev_monthly_referral_count: Integer,
              referrals: T::Array[String],
              referral_source: Growsurf::Campaign::ReferralSource::TaggedSymbol,
              referral_status: Growsurf::Campaign::ReferralStatus::TaggedSymbol,
              referred_by: String,
              referrer:
                T.nilable(Growsurf::Campaign::CampaignParticipant::Referrer),
              share_count: T::Hash[Symbol, Integer],
              unique_impression_count: Integer,
              unread_commissions_count: Integer,
              unread_payouts_count: Integer,
        ...
        class Referrer < Growsurf::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Growsurf::Campaign::CampaignParticipant::Referrer,
                Growsurf::Internal::AnyHash
              )
            end
            ...
            override.returns(
              {
                ...
                referrals: T::Array[String],
                referral_source:
                  Growsurf::Campaign::ReferralSource::TaggedSymbol,
                referral_status:
