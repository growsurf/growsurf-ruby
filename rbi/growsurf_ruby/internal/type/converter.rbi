  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(GrowsurfRuby::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              GrowsurfRuby::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: GrowsurfRuby::Internal::Type::Converter::Input,
              value: T.anything,
              state: GrowsurfRuby::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
