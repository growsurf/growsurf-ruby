    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: GrowsurfRuby::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  GrowsurfRuby::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
          ...
          sig do
            params(
              ...
              spec: GrowsurfRuby::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: GrowsurfRuby::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: GrowsurfRuby::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: GrowsurfRuby::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(GrowsurfRuby::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(GrowsurfRuby::Internal::AnyHash) }
        def to_h
        end
