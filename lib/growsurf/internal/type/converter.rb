    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Growsurf::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Growsurf::Internal::Type::Unknown.dump(_1, state: state) }
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Growsurf::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Growsurf::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Growsurf::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Growsurf::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Growsurf::Internal::Type::Converter
              ...
              Growsurf::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Growsurf::Internal::Type::Converter, T::Class[T.anything]) }
        end
