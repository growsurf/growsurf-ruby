...
module Growsurf
  module Models
    ...
    class CampaignAPI < Growsurf::Internal::Type::BaseModel
      ...
      # @!attribute rewards
      #
      #   @return [Array<Growsurf::Models::CampaignAPI::Reward>]
      required :rewards, -> { Growsurf::Internal::Type::ArrayOf[Growsurf::CampaignAPI::Reward] }

      # @!attribute status
      #
      #   @return [Symbol, Growsurf::Models::CampaignAPI::Status]
      required :status, enum: -> { Growsurf::CampaignAPI::Status }

      # @!attribute type
      #
      #   @return [Symbol, Growsurf::Models::CampaignAPI::Type]
      required :type, enum: -> { Growsurf::CampaignAPI::Type }
      ...
      #   @param rewards [Array<Growsurf::Models::CampaignAPI::Reward>]
      #   @param status [Symbol, Growsurf::Models::CampaignAPI::Status]
      #   @param type [Symbol, Growsurf::Models::CampaignAPI::Type]
      ...
      class Reward < Growsurf::Internal::Type::BaseModel
        ...
        #
        #   @return [Boolean]
        required :is_unlimited, Growsurf::Internal::Type::Boolean, api_name: :isUnlimited

        # @!attribute metadata
        #   Shallow custom metadata object.
        #
        #   @return [Hash{Symbol=>Object}]
        required :metadata, Growsurf::Internal::Type::HashOf[Growsurf::Internal::Type::Unknown]

        # @!attribute type
        #
        #   @return [Symbol, Growsurf::Models::CampaignAPI::Reward::Type]
        required :type, enum: -> { Growsurf::CampaignAPI::Reward::Type }
        ...
        #
        #   @return [Symbol, Growsurf::Models::CampaignAPI::Reward::LimitDuration, nil]
        optional :limit_duration,
                 enum: -> { Growsurf::CampaignAPI::Reward::LimitDuration },
        ...
        #
        #   @return [Boolean, nil]
        optional :referred_reward_upfront, Growsurf::Internal::Type::Boolean, api_name: :referredRewardUpfront
        ...
        #
        #   @param type [Symbol, Growsurf::Models::CampaignAPI::Reward::Type]
        #
        ...
        #
        #   @param limit_duration [Symbol, Growsurf::Models::CampaignAPI::Reward::LimitDuration, nil]
        #
        ...
        # @see Growsurf::Models::CampaignAPI::Reward#type
        module Type
        ...
        # @see Growsurf::Models::CampaignAPI::Reward#limit_duration
      ...
      # @see Growsurf::Models::CampaignAPI#status
      module Status
        extend Growsurf::Internal::Type::Enum
      ...
      # @see Growsurf::Models::CampaignAPI#type
      module Type
        extend Growsurf::Internal::Type::Enum
