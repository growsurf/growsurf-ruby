...
module Growsurf
  module Models
    class CommissionStructure < Growsurf::Internal::Type::BaseModel
      # @!attribute amount
      #
      #   @return [Integer, nil]
      ...
      #
      #   @return [Boolean, nil]
      optional :approval_required, Growsurf::Internal::Type::Boolean, api_name: :approvalRequired, nil?: true
      ...
      #
      #   @return [Boolean, nil]
      optional :has_intro, Growsurf::Internal::Type::Boolean, api_name: :hasIntro, nil?: true

      # @!attribute has_max_amount
      #
      #   @return [Boolean, nil]
      optional :has_max_amount, Growsurf::Internal::Type::Boolean, api_name: :hasMaxAmount, nil?: true
      ...
      # @!attribute type
      #
      #   @return [Symbol, Growsurf::Models::CommissionStructure::Type, nil]
      optional :type, enum: -> { Growsurf::CommissionStructure::Type }, nil?: true
      ...
      #   @param type [Symbol, Growsurf::Models::CommissionStructure::Type, nil]

      # @see Growsurf::Models::CommissionStructure#type
      module Type
