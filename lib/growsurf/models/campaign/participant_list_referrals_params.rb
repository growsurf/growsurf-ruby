...
module Growsurf
  module Models
    module Campaign
      # @see Growsurf::Resources::Campaign::Participant#list_referrals
      class ParticipantListReferralsParams < Growsurf::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Growsurf::Models::Campaign::ParticipantListReferralsParams::SortBy, nil]
        optional :sort_by, enum: -> { Growsurf::Campaign::ParticipantListReferralsParams::SortBy }

        # @!method initialize(id:, participant_id_or_email:, desc: nil, email: nil, first_name: nil, last_name: nil, limit: nil, next_id: nil, offset: nil, referral_status: nil, sort_by: nil, request_options: {})
        #   @param id [String]
        #
        ...
        #
        #   @param sort_by [Symbol, Growsurf::Models::Campaign::ParticipantListReferralsParams::SortBy] Field used to sort referral results.
        #
