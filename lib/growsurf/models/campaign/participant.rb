...
module Growsurf
  module Models
    module Campaign
      # @see Growsurf::Resources::Campaign::Participant#retrieve
      class CampaignParticipant < Growsurf::Internal::Type::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        #
        #   @return [Symbol, Growsurf::Models::Campaign::FraudRiskLevel, nil]
        optional :fraud_risk_level, enum: -> { Growsurf::Campaign::FraudRiskLevel }, api_name: :fraudRiskLevel
        ...
        #
        #   @return [Boolean, nil]
        optional :is_new, Growsurf::Internal::Type::Boolean, api_name: :isNew

        # @!attribute is_winner
        #
        #   @return [Boolean, nil]
        optional :is_winner, Growsurf::Internal::Type::Boolean, api_name: :isWinner
        ...
        optional :monthly_referrals, Growsurf::Internal::Type::ArrayOf[String], api_name: :monthlyReferrals
        ...
        #
        #   @return [Array<String>, nil]
        optional :referrals, Growsurf::Internal::Type::ArrayOf[String]

        # @!attribute referral_source
        #
        #   @return [Symbol, Growsurf::Models::Campaign::ReferralSource, nil]
        optional :referral_source, enum: -> { Growsurf::Campaign::ReferralSource }, api_name: :referralSource

        # @!attribute referral_status
        #
        #   @return [Symbol, Growsurf::Models::Campaign::ReferralStatus, nil]
        optional :referral_status, enum: -> { Growsurf::Campaign::ReferralStatus }, api_name: :referralStatus
        ...
        # @!attribute referrer
        #
        #   @return [Growsurf::Models::Campaign::CampaignParticipant::Referrer, nil]
        optional :referrer, -> { Growsurf::Campaign::CampaignParticipant::Referrer }, nil?: true

        # @!attribute share_count
        #
        #   @return [Hash{Symbol=>Integer}, nil]
        optional :share_count, Growsurf::Internal::Type::HashOf[Integer], api_name: :shareCount
        ...
        #
        #   @param fraud_risk_level [Symbol, Growsurf::Models::Campaign::FraudRiskLevel]
        #
        ...
        #
        #   @param referral_source [Symbol, Growsurf::Models::Campaign::ReferralSource]
        #
        #   @param referral_status [Symbol, Growsurf::Models::Campaign::ReferralStatus]
        #
        #   @param referred_by [String]
        #
        #   @param referrer [Growsurf::Models::Campaign::CampaignParticipant::Referrer, nil]
        #
        ...
        # @see Growsurf::Models::Campaign::CampaignParticipant#referrer
        class Referrer < Growsurf::Internal::Type::BaseModel
          # @!attribute id
          #
          #   @return [String, nil]
          optional :id, String
          ...
          optional :fraud_risk_level,
                   enum: -> {
                     Growsurf::Campaign::FraudRiskLevel
                   },
          ...
          optional :referral_source,
                   enum: -> {
                     Growsurf::Campaign::ReferralSource
                   },
          ...
          optional :referral_status,
                   enum: -> {
                     Growsurf::Campaign::ReferralStatus
                   },
