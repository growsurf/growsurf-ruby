...
module Growsurf
  class Client < Growsurf::Internal::Transport::BaseClient
    ...
    # @return [Growsurf::Resources::Campaign]
    ...
    #
    # @param api_key [String, nil] GrowSurf REST API key supplied as `Authorization: Bearer <api_key>`. Defaults to
    ...
    def initialize(
      ...
      @campaign = Growsurf::Resources::Campaign.new(client: self)
    end
  end
end
