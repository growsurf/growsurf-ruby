    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          #
          # @param child [Class<GrowsurfRuby::Internal::Type::BaseModel>]
          def inherited(child)
            super
          ...
          #
          # @param type_info [Hash{Symbol=>Object}, Proc, GrowsurfRuby::Internal::Type::Converter, Class]
          #
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            meta = GrowsurfRuby::Internal::Type::Converter.meta_info(type_info, spec)
            type_fn, info =
              case type_info
              in Proc | GrowsurfRuby::Internal::Type::Converter | Class
                [GrowsurfRuby::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [GrowsurfRuby::Internal::Type::Converter.type_info(type_info), type_info]
              end

            setter = :"#{name_sym}="
            api_name = info.fetch(:api_name, name_sym)
            nilable = info.fetch(:nil?, false)
            const = required && !nilable ? info.fetch(:const, GrowsurfRuby::Internal::OMIT) : GrowsurfRuby::Internal::OMIT
            ...
            define_method(setter) do |value|
              ...
              stored =
                case [target, status]
                in [GrowsurfRuby::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if GrowsurfRuby::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise GrowsurfRuby::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  value = @data.fetch(name_sym) { const == GrowsurfRuby::Internal::OMIT ? nil : const }
                  state = GrowsurfRuby::Internal::Type::Converter.new_coerce_state(translate_names: false)
                  if (nilable || !required) && value.nil?
                    nil
                  else
                    GrowsurfRuby::Internal::Type::Converter.coerce(
          ...
          # @return [Boolean]
          def ==(other)
            other.is_a?(Class) && other <= GrowsurfRuby::Internal::Type::BaseModel && other.fields == fields
          end
        ...
        class << self
          # @api private
          #
          # @param value [GrowsurfRuby::Internal::Type::BaseModel, Hash{Object=>Object}, Object]
          #
          ...
          def coerce(value, state:)
            ...
            unless (val = GrowsurfRuby::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
            ...
            fields.each do |name, field|
              ...
              unless val.key?(src_name)
                if required && mode != :dump && const == GrowsurfRuby::Internal::OMIT
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = GrowsurfRuby::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in GrowsurfRuby::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value, state:)
            unless (coerced = GrowsurfRuby::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, GrowsurfRuby::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
            ...
            known_fields.each_value do |field|
              ...
              next if mode == :coerce || acc.key?(api_name) || const == GrowsurfRuby::Internal::OMIT
        ...
        class << self
          # @api private
          #
          # @param model [GrowsurfRuby::Internal::Type::BaseModel]
        ...
        #
        # @example
        #   # `campaign_api` is a `GrowsurfRuby::CampaignAPI`
        #   campaign_api => {
        #     id: id,
        ...
        #
        # @return [String]
        def to_json(*a) = GrowsurfRuby::Internal::Type::Converter.dump(self.class, self).to_json(*a)
        ...
        #
        # @return [String]
        def to_yaml(*a) = GrowsurfRuby::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                GrowsurfRuby::Internal::Type::Converter.inspect(type, depth: depth),
