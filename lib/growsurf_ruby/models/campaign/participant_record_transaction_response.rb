...
module GrowsurfRuby
  module Models
    module Campaign
      # @see GrowsurfRuby::Resources::Campaign::Participant#record_transaction
      module ParticipantRecordTransactionResponse
        extend GrowsurfRuby::Internal::Type::Union

        variant -> { GrowsurfRuby::Models::Campaign::ParticipantRecordTransactionResponse::UnionMember0 }

        variant -> { GrowsurfRuby::Models::Campaign::ParticipantRecordTransactionResponse::UnionMember1 }
        ...
        class UnionMember1 < GrowsurfRuby::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<String>]
          required :duplicate_fields,
                   GrowsurfRuby::Internal::Type::ArrayOf[String],
                   api_name: :duplicateFields
        ...
        #   @return [Array(GrowsurfRuby::Models::Campaign::ParticipantRecordTransactionResponse::UnionMember0, GrowsurfRuby::Models::Campaign::ParticipantRecordTransactionResponse::UnionMember1)]
      end
    end
  end
end
