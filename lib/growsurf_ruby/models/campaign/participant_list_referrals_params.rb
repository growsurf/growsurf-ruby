...
module GrowsurfRuby
  module Models
    module Campaign
      # @see GrowsurfRuby::Resources::Campaign::Participant#list_referrals
      class ParticipantListReferralsParams < GrowsurfRuby::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, GrowsurfRuby::Models::Campaign::ParticipantListReferralsParams::SortBy, nil]
        ...
        #
        #   @param sort_by [Symbol, GrowsurfRuby::Models::Campaign::ParticipantListReferralsParams::SortBy] Field used to sort referral results.
        #
